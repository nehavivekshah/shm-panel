...
# Create directory for custom Nginx configs (htaccess conversion)
mkdir -p /etc/nginx/shm-custom
chown www-data:www-data /etc/nginx/shm-custom
chmod 755 /etc/nginx/shm-custom
